...
class SurahHeaderWidget extends StatelessWidget {
  ...
  /// اسم السورة بالعربية من القائمة، أو الرقم كاحتياط
  String get _surahDisplayName {
    if (surahNumber >= 1 &&
        surahNumber <= quranCtrl.surahsList.length &&
        quranCtrl.surahsList.isNotEmpty) {
      return quranCtrl.surahsList[surahNumber - 1].name;
    }
